...
const multi_crypto_buy = multiply['Pkr']['Crypto_buy']
const multi_crypto_sell = multiply['Pkr']['Crypto_sell']

const multi_currency_buy = multiply['Pkr']['Currency_buy']
const multi_currency_sell = multiply['Pkr']['CUrrency_sell']
