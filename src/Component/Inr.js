...
const multi_crypto_buy = multiply['Inr']['Crypto_buy']
const multi_crypto_sell = multiply['Inr']['Crypto_sell']

const multi_currency_buy = multiply['Inr']['Currency_buy']
const multi_currency_sell = multiply['Inr']['CUrrency_sell']
